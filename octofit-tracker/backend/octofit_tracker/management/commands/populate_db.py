...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user=captain, type='bike', duration=60, distance=20)
        ...
        # Crear workouts
        Workout.objects.create(name='Cardio Blast', description='Entrenamiento de cardio intenso', suggested_for='run')
        Workout.objects.create(name='Bike Power', description='Entrenamiento de ciclismo', suggested_for='bike')
        Workout.objects.create(name='Swim Pro', description='Entrenamiento de natación', suggested_for='swim')
